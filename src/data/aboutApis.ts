...
export const getAbout=async ()=>{
    const response=await axios.get('https://adminbackend-fawn.vercel.app/api/about/get')
    return response
}
...
export const updateAbout = async (data: UpdateAboutData) => {
    ...
    const response = await axios.put('https://adminbackend-fawn.vercel.app/api/about/update', formData, {
        headers: {
